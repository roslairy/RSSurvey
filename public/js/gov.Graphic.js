...
gov.Graphic.prototype={
	...
	setOptions: function(options) {
		this.options = {
			height:170,                 //»æÍ¼ÇøÓò¸ß¶È
			maxHeight:50,              //yÖá×î¸ßÊýÖµ
			barDistance:26,           //xÖá×ø±ê¼ä¾à
			topDistance:0,             //ÉÏ²¿Ìî³ä
			bottomDistance:0,        //µ×²¿Ìî³ä
			leftDistance:20,
			pointWidth:5,               //×ø±êµã¿í¶È
			pointHeight:5,             //×ø±êµã¸ß¶È
			pointColor:"#ff0000",     //×ø±êµãÑÕÉ«
			lineColor:"#ffd43a",       //Á¬½ÓÏßÑÕÉ«
			valueWidth:20,            //yÖáÊýÖµ¿í¶È
			valueColor:"#000",       //yÖáÊýÖµÑÕÉ«
			timeWidth:20,             //xÖáÊýÖµ¿í¶È
			timeColor:"#000",       //xÖáÊýÖµÑÕÉ«
			disvalue:true,             //ÊÇ·ñÏÔÊ¾yÖáÊýÖµ
			distime:true              //ÊÇ·ñÏÔÊ¾xÖáÊýÖµ
		}
